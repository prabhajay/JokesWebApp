...
namespace JokesWebApp.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View("Index",await _context.Jokes.Where(j =>j.JokeQuestions.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,JokeQuestions,Answer")] Jokes jokes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,JokeQuestions,Answer")] Jokes jokes)
        {
            if (id != jokes.Id)
            {
                return NotFound();
